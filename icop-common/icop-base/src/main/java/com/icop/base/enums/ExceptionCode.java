...
public enum  ExceptionCode implements IExceptionCode {
    ...
    UNKNOWN_HOST(40009, "未知主机！"),
    JSON_PARSE_ERROR(40009, "JSON解析异常！"),

    REDIS_NO_CACHE(40020, "无效的缓存空间{0}！"),
    ...
    public ExceptionCode buildMsg(String msg, Object... param) {
        this.msg = String.format(msg, param);
        return this;
    }

    public String getMsg(String msg, Object... param) {
